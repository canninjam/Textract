	...
	public class TextractTextDetectionService {
		...
		public async Task<string> StartDocumentTextDetection(string bucketName, string key) {
			...
			request.DocumentLocation = new DocumentLocation {
				...
				{
					Bucket = "abhishekdata",
					Name = "Amazon-Textract-Pdf.pdf"
				}

               // Bytes = new MemoryStream(File.ReadAllBytes(@"C:\Users\Dell\Downloads\amazon-textract-code-samples-master\amazon-textract-code-samples-master\src-csharp\test-files\Amazon-Textract-Pdf.pdf"))
			};
